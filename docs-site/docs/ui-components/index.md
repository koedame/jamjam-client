...
sidebar_position: 1
title: コンポーネントカタログ
description: jamjam UI コンポーネント一覧と仕様
---
...
| VerticalTabs | SettingsPanel | settings-panel.md内 | [settings-panel.md#verticaltabs](./settings-panel.md#verticaltabs垂直タブナビゲーション) |
