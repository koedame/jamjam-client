...
| ID | 要求 | criticality |
|----|------|------------|
| REQ-RMT-001 | 手伝いは、手伝う人が申請し、手伝われる人が許可して初めて始まる。許可すると手伝う人に手伝われる人の音声の設定が届き、ルームのチャットに開始が記録される。断ると何も始まらない | must |
| REQ-RMT-002 | 手伝う人の変更は 1 件ずつ申請として手伝われる人に届き、許可したものだけが適用される（設定ウィンドウで変えたときと同じ処理で）。断ったもの・答えないまま手伝いが終わったものは適用されない。手伝う人には結果（適用された設定・断られた・適用できなかった）が届く。手伝っていない参加者からの申請・答えは捨てる | must |
| REQ-RMT-003 | 手伝う人も手伝われる人も、いつでも手伝いを止められる（手伝う人は、返事の前の申請も取り下げられる）。止めた・相手が退出した・自分が退出した・接続が切れたとき、手伝いは終わり、待っている変更は捨てられる | must |
| REQ-RMT-004 | 変更が適用されるたびに、ルームのチャットに「（手伝う人）さんが（手伝われる人）さんの（設定の名前）設定を変更しました」と記録される。文は受け取ったアプリが自分の言語で組み立てる | must |
| REQ-RMT-005 | 手伝いは、手伝う側としても手伝われる側としても同時に 1 本まで。手伝われている最中に別の人から来た申請は、利用者に聞かずに断る | must |
| REQ-RMT-006 | 手伝う人には、手伝われる人のデバイス ID を渡さない（シリアル番号が入りうる）。手伝いのあいだだけ使う仮の名前で渡し、変更の申請に付いてきた仮の名前を手伝われる側で元の ID に戻す。知らない仮の名前の申請は、利用者に聞かずに断る | must |
