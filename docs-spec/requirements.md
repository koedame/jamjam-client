...
| REQ-RMT-005 | 手伝いは、手伝う側としても手伝われる側としても同時に 1 本まで。手伝われている最中に別の人から来た申請は、利用者に聞かずに断る。断る返事は申請した人ごとに 1 回まで（何度申請されても返事を増やさない。相手の送信でこちらがサーバーの送信上限に達して切られないため） | must |
